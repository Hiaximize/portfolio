        ...
        return(
            <div id="myProjectsContainer">
                ...
                <div id="projectsContainer">
                    ...
                    <a rel="noopener noreferrer" target="_blank" href="my-tiny-home.herokuapp.com"><img className="projects" id="tinyHome" className="projects slit-in-vertical" src="tinyHomeMarketPlace.gif" alt="TinyHomeMarket"></img></a>
